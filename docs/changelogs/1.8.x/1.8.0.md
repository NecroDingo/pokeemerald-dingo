...
* Added `randompercentage` and `randomelement` script commands by @mrgriffin in https://github.com/rh-hideout/pokeemerald-expansion/pull/4189
    * Allows to do the following:
        ```
        @ VAR_RESULT is one of Bulbasaur, Chimchar, or Mudkip
        randomelement SPECIES_BULBASAUR, SPECIES_CHIMCHAR, SPECIES_MUDKIP
        @ Gives a random one of Bulbasaur, Chimchar, or Mudkip.
